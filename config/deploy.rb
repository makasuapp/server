...
set :linked_dirs, %w{tmp/pids tmp/cache tmp/sockets log vendor/bundle public/system public/uploads}
set :rvm_ruby_version, '2.5.3'

set :puma_rackup, -> { File.join(current_path, 'config.ru') }
set :puma_state, "#{shared_path}/tmp/pids/puma.state"
set :puma_pid, "#{shared_path}/tmp/pids/puma.pid"
set :puma_bind, "unix://#{shared_path}/tmp/sockets/puma.sock" #["tcp://0.0.0.0:9292", "unix://#{shared_path}/tmp/sockets/puma.sock"]
...
set :nginx_ssl_certificate_key, "/etc/letsencrypt/live/#{domain_name}/privkey.pem"
