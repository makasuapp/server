...
class ProcurementControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @salt.update_attributes!(got_qty: 1, got_unit: "g", price_cents: 1000, price_unit: "kg")
  end
  ...
  test "update_items updates qty and price" do
    ...
    updates = []
    updates << {id: @salt.id}
    updates << {id: @chicken.id, got_qty: 2.5, price_cents: 2000, price_unit: "kg"}
    updates << {id: @chicken.id, got_qty: 3.5, price_cents: 2500, price_unit: "g"}
