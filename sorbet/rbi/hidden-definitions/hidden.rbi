...
class AASM::Configuration
  ...
  def create_scopes=(create_scopes); end
  ...
  def no_direct_assignment=(no_direct_assignment); end

  def requires_lock(); end

  def requires_lock=(requires_lock); end

  def requires_new_transaction(); end

  def requires_new_transaction=(requires_new_transaction); end

  def skip_validation_on_save(); end

  def skip_validation_on_save=(skip_validation_on_save); end
  ...
  def whiny_persistence=(whiny_persistence); end

  def whiny_transitions(); end

  def whiny_transitions=(whiny_transitions); end

  def with_klass(); end

  def with_klass=(with_klass); end
end

class AASM::Configuration
  def self.hide_warnings(); end

  def self.hide_warnings=(hide_warnings); end
end
...
class AASM::InstanceBase
  ...
  def current_event=(current_event); end
...
class AASM::NoDirectAssignmentError
end
...
module AASM::Persistence::ActiveRecordPersistence::ClassMethods
  def aasm_create_scope(state_machine_name, scope_name); end
end
...
module AASM::Persistence::ORM
  def aasm_write_state(state, name=T.unsafe(nil)); end

  def aasm_write_state_without_persistence(state, name=T.unsafe(nil)); end
end
...
module AASM::Persistence
  def self.load_persistence(base); end
end
...
class AASM::StateMachine
  ...
  def global_callbacks=(global_callbacks); end

  def initial_state(); end

  def initial_state=(initial_state); end
...
class AASM::StateMachineStore
  def self.[](klass, fallback=T.unsafe(nil)); end

  def self.[]=(klass, overwrite=T.unsafe(nil), state_machine=T.unsafe(nil)); end

  def self.fetch(klass, fallback=T.unsafe(nil)); end

  def self.register(klass, overwrite=T.unsafe(nil), state_machine=T.unsafe(nil)); end

  def self.stores(); end

  def self.unregister(klass); end
end
...
class AASM::UnknownStateMachineError
end
...
module ActiveAdmin::Helpers::Routes::UrlHelpers
  ...
  def api_op_days_save_prep_qty_url(*args); end
...
class Customer::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Customer::GeneratedRelationMethods
end

class Customer::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Customer::GeneratedRelationMethods
end

class Customer::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Customer::GeneratedRelationMethods
end
...
module Customer::GeneratedRelationMethods
end
...
class DayPrep::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::DayPrep::GeneratedRelationMethods
end

class DayPrep::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::DayPrep::GeneratedRelationMethods
end

class DayPrep::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::DayPrep::GeneratedRelationMethods
end
...
class ItemPrice::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::ItemPrice::GeneratedRelationMethods
end

class ItemPrice::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::ItemPrice::GeneratedRelationMethods
end

class ItemPrice::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::ItemPrice::GeneratedRelationMethods
end
...
module ItemPrice::GeneratedRelationMethods
end
...
class OpDay
  ...
  def after_add_for_day_preps=(val); end
  ...
  def after_remove_for_day_preps=(val); end
  ...
  def before_add_for_day_preps=(val); end
...
class OpDay
  ...
  def self.after_add_for_day_preps=(val); end
  ...
  def self.after_remove_for_day_preps=(val); end
  ...
  def self.before_add_for_day_preps=(val); end
...
class Order
  ...
  def deliver_without_validation!(*args, &block); end

  def delivered?(); end

  def done?(); end

  def finish(*args, &block); end

  def finish!(*args, &block); end

  def finish_without_validation!(*args, &block); end

  def may_deliver?(*args); end

  def may_finish?(*args); end

  def may_start?(*args); end
  ...
  def start_without_validation!(*args, &block); end
  ...
  def versions_association_name?(); end
  STATE_DELIVERED = ::T.let(nil, ::T.untyped)
  STATE_DONE = ::T.let(nil, ::T.untyped)
  STATE_NEW = ::T.let(nil, ::T.untyped)
  STATE_STARTED = ::T.let(nil, ::T.untyped)
end
...
module Order::GeneratedRelationMethods
  ...
  def done(*args, &block); end

  def started(*args, &block); end
end

module Order::GeneratedRelationMethods
end

class Order::Version::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Order::Version::GeneratedRelationMethods
end

class Order::Version::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Order::Version::GeneratedRelationMethods
end

class Order::Version::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Order::Version::GeneratedRelationMethods
end

module Order::Version::GeneratedRelationMethods
end
...
class OrderItem::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::OrderItem::GeneratedRelationMethods
end

class OrderItem::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::OrderItem::GeneratedRelationMethods
end

class OrderItem::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::OrderItem::GeneratedRelationMethods
end
...
class PaperTrail::Config
  ...
  def has_paper_trail_defaults=(has_paper_trail_defaults); end
...
class Recipe
  def after_add_for_item_prices(); end

  def after_add_for_item_prices=(val); end
  ...
  def after_remove_for_item_prices(); end

  def after_remove_for_item_prices=(val); end
  ...
  def before_add_for_item_prices(); end

  def before_add_for_item_prices=(val); end
  ...
  def before_remove_for_item_prices(); end

  def before_remove_for_item_prices=(val); end
...
class Recipe
  extend ::T::Private::Methods::MethodHooks
  extend ::T::Private::Methods::SingletonMethodHooks
  def self.after_add_for_item_prices(); end

  def self.after_add_for_item_prices=(val); end
  ...
  def self.after_remove_for_item_prices(); end

  def self.after_remove_for_item_prices=(val); end
  ...
  def self.before_add_for_item_prices(); end

  def self.before_add_for_item_prices=(val); end
  ...
  def self.before_remove_for_item_prices(); end

  def self.before_remove_for_item_prices=(val); end
