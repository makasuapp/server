...
class Net::SSH::Proxy::Command
  ...
  def open(host, port, connection_options = nil); end
  def timeout; end
...
class InvalidName___Class_0x00___KeyType_37
  def self.encrypted_key?(data, error); end
  def self.error_classes; end
  def self.read(key_data, passphrase); end
end
class InvalidName___Class_0x00___OpenSSHPrivateKeyType_38 < InvalidName___Class_0x00___KeyType_37
  def self.encrypted_key?(key_data, decode_error); end
  def self.error_classes; end
  def self.read(key_data, passphrase); end
end
class InvalidName___Class_0x00___OpenSSLKeyTypeBase_39 < InvalidName___Class_0x00___KeyType_37
  def self.encrypted_key?(key_data, error); end
  def self.open_ssl_class; end
  def self.read(key_data, passphrase); end
end
class InvalidName___Class_0x00___OpenSSLPKeyType_40 < InvalidName___Class_0x00___OpenSSLKeyTypeBase_39
  def self.error_classes; end
  def self.open_ssl_class; end
  def self.read(key_data, passphrase); end
end
class InvalidName___Class_0x00___OpenSSLDSAKeyType_41 < InvalidName___Class_0x00___OpenSSLKeyTypeBase_39
  def self.error_classes; end
  def self.open_ssl_class; end
end
class InvalidName___Class_0x00___OpenSSLRSAKeyType_42 < InvalidName___Class_0x00___OpenSSLKeyTypeBase_39
  def self.error_classes; end
  def self.open_ssl_class; end
end
class InvalidName___Class_0x00___OpenSSLECKeyType_43 < InvalidName___Class_0x00___OpenSSLKeyTypeBase_39
  def self.error_classes; end
  def self.open_ssl_class; end
end
