...
module Order::GeneratedAssociationMethods
  ...
  sig { params(args: T.untyped, block: T.nilable(T.proc.params(object: ::Integration).void)).returns(::Integration) }
  def build_integration(*args, &block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.params(object: ::Integration).void)).returns(::Integration) }
  def create_integration(*args, &block); end
  ...
  sig { returns(::Order::Version::ActiveRecord_Associations_CollectionProxy) }
  def versions; end

  sig { returns(T::Array[Integer]) }
  def version_ids; end

  sig { params(value: T::Enumerable[::Order::Version]).void }
